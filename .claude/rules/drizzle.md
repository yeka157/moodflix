...
- **RLS still matters** for Supabase realtime subscriptions and any client-side reads via the Supabase JS client. Append new policies to `drizzle/rls-policies.sql` AND apply them manually in the Supabase Dashboard SQL Editor before deploying.
