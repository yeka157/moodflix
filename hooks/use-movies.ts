...
import type { DiscoverMoviesParams } from "@/lib/movie-keys";
import { getDefaultDiscoverParams, movieKeys } from "@/lib/movie-keys";
export type { DiscoverMoviesParams } from "@/lib/movie-keys";
export { getDefaultDiscoverParams, movieKeys } from "@/lib/movie-keys";
