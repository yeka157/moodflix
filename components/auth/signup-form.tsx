  ...
  return (
    <>
      <h1 className="font-display uppercase text-[48px] md:text-[64px] leading-[0.9] tracking-[0.005em] m-0 mb-3">
        Start <span className="font-serif italic normal-case text-primary">watching.</span>
      </h1>
      <p className="text-[var(--ink-2)] mb-9">
        A movie tracker that listens. Free forever, no ads, no algorithm games.
      </p>
      ...
      <div className={DIVIDER_CLASSES}>or sign up with email</div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <div className="mb-4">
          <label htmlFor="signup-confirm" className={LABEL_CLASSES}>Confirm password</label>
          <input
            id="signup-confirm"
            type="password"
            autoComplete="new-password"
          ...
          {errors.confirmPassword && (
            <p className="text-xs text-primary mt-1.5">{errors.confirmPassword.message}</p>
          )}
        </div>
